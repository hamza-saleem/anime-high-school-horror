...
//	private InputControl InputComponent;
    ...
    [Tooltip("Number that indicates game type on starting the game. -1 = ignore this value, 0 = Story Mode, 1 = Faction War, 2 = Wave Mode")]
    public int initialGameType = -1;
...
//		InputComponent = FPSPlayerComponent.InputComponent;
        ...
        if(initialGameType > 0){
            PlayerPrefs.SetInt("Game Type", initialGameType);
        }
...
//					  " Level : " + level.ToString() + " XP : " + kills.ToString() + " / " + nextLevelKills.ToString());
		...
		//SAVE SYSTEM CODE by Pixel Crushers goes here! https://www.assetstore.unity3d.com/en/#!/content/83057
