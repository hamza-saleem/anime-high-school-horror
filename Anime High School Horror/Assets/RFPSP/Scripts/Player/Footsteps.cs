...
public class Footsteps : MonoBehaviour {
	...
	[Tooltip("Volume of floor footstep sounds.")]
	public float floorSoundVol = 1.0f;
	[Tooltip("Array containing sound effects to be used for water footsteps.")]
	public AudioClip[] floorSounds;
						...
						if (FPSWalkerComponent.grounded && (FPSWalkerComponent.landStartTime + 0.3f) < Time.time){
							...
							if(!onTerrain){
								...
								case "Grass":
									...
									break;
								case "Floor":
									if (floorSounds.Length > 0)
									{
											footStepClip = floorSounds[Random.Range(0, floorSounds.Length)];
											volumeAmt = floorSoundVol;
									}
										break;
								default:
